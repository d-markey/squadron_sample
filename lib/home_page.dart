...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String get _pi => _digits.isEmpty ? '' : [ _digits[0].toRadixString(16), '.' , ..._digits.skip(1).map((d) => d.toRadixString(16))].join('');
