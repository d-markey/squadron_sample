...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DateTime_parse(formattedString) {
      ...
      if (match != null) {
        ...
        t3 = t2[1];
        t3.toString;
        years = A.int_parse(t3, _null, _null);
        if (2 >= t2.length)
          return A.ioore(t2, 2);
        t3 = t2[2];
        t3.toString;
        month = A.int_parse(t3, _null, _null);
        if (3 >= t2.length)
          return A.ioore(t2, 3);
        t3 = t2[3];
        t3.toString;
        day = A.int_parse(t3, _null, _null);
        if (4 >= t2.length)
          return A.ioore(t2, 4);
        hour = t1.call$1(t2[4]);
        if (5 >= t2.length)
        ...
        if (t2[8] != null) {
          ...
          if (tzSign != null) {
            ...
            t3 = t2[10];
            t3.toString;
            hourDifference = A.int_parse(t3, _null, _null);
            if (11 >= t2.length)
    ...
    bootstrap(initializer, command, logger) {
      var t2, sq, runner, t3, t4, t5,
        t1 = self;
      t1.toString;
      type$.DedicatedWorkerGlobalScope._as(t1);
      t2 = new MessageChannel();
      t2.toString;
      sq = A.Squadron__getOrInitialize();
      $.Squadron__instance != null;
      sq._logger = logger;
      runner = new A.WorkerRunner(A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.dynamic_Function_List_dynamic), new A.WorkerMonitor(new A.bootstrap_closure(t2, t1), A.LinkedHashMap_LinkedHashMap$_empty(type$.String, type$.CancellationTokenReference)));
      t3 = t2.port1;
      t3.toString;
      t4 = type$.nullable_void_Function_MessageEvent;
      t5 = type$.MessageEvent;
      A._EventStreamSubscription$(t3, "message", t4._as(new A.bootstrap_closure0(runner)), false, t5);
      A._EventStreamSubscription$(t1, "message", t4._as(new A.bootstrap_closure1(runner, t2, initializer)), false, t5);
    },
    ...
    newSquadronError(message, stackTrace) {
      var t1;
    ...
    WorkerService: function WorkerService() {
    },
    ...
    GenericData_GenericData$fromJson(json, $T) {
      var deserializer, exception,
        t1 = J.getInterceptor$asx(json),
        $name = t1.$index(json, "n"),
        value = t1.$index(json, "v");
      if (value == null)
        return new A.GenericData(A._asString($name), null, $T._eval$1("GenericData<0>"));
      else {
        deserializer = $.GenericData__deserializers.$index(0, A.createRuntimeType($T));
        if (deserializer != null)
          try {
            value = $T._as(deserializer.call$1(value));
          } catch (exception) {
          }
        return new A.GenericData(A._asString($name), $T._eval$1("0?")._as(value), $T._eval$1("GenericData<0>"));
      }
    },
    GenericData: function GenericData(t0, t1, t2) {
      this.name = t0;
      this.value = t1;
      this.$ti = t2;
    },
    StringPersonMarshaller: function StringPersonMarshaller() {
    },
    $PerfInitializer(startRequest) {
      type$.Map_dynamic_dynamic._as(J.$index$asx(type$.List_dynamic._as(J.$index$asx(startRequest, 3)), 0));
      $.$get$PerfContext_singleton();
      return new A.Perf(null);
    },
    Person___fromJson_tearOff(json) {
      var t1 = J.getInterceptor$asx(json);
      return new A.Person(A._asString(t1.$index(json, 0)), A._asString(t1.$index(json, 1)), A.DateTime_parse(A._asString(t1.$index(json, 2))));
    },
    $PerfOperations: function $PerfOperations() {
    },
    $PerfOperations_operations_closure: function $PerfOperations_operations_closure(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure0: function $PerfOperations_operations_closure0(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure1: function $PerfOperations_operations_closure1(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure2: function $PerfOperations_operations_closure2(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure3: function $PerfOperations_operations_closure3(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure4: function $PerfOperations_operations_closure4(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure5: function $PerfOperations_operations_closure5(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure6: function $PerfOperations_operations_closure6(t0) {
      this.$this = t0;
    },
    $PerfOperations_operations_closure7: function $PerfOperations_operations_closure7(t0) {
      this.$this = t0;
    },
    Person: function Person(t0, t1, t2) {
      this.lastName = t0;
      this.firstName = t1;
      this.dob = t2;
    },
    PerfContext: function PerfContext() {
    },
    Perf: function Perf(t0) {
      this.$$PerfOperations__operations = t0;
    },
    Perf_negateWithListInput_closure: function Perf_negateWithListInput_closure() {
    },
    Perf_negateWithByteBufferInput_closure: function Perf_negateWithByteBufferInput_closure() {
    },
    Perf_negateWithStringInput_closure: function Perf_negateWithStringInput_closure() {
    },
    Perf_negateWithListOutput_closure: function Perf_negateWithListOutput_closure() {
    },
    Perf_negateWithByteBufferOutput_closure: function Perf_negateWithByteBufferOutput_closure() {
    },
    Perf_negateWithJsonOutput_closure: function Perf_negateWithJsonOutput_closure() {
    },
    _Perf_WorkerService_$PerfOperations: function _Perf_WorkerService_$PerfOperations() {
    },
    printString(string) {
    ...
    Transferables__getObjects($async$list, $async$seen) {
      return A._makeSyncStarIterable(function() {
        var list = $async$list,
          seen = $async$seen;
        var $async$goto = 0, $async$handler = 1, $async$currentError, t1, t2, t3, o, t4;
        return function $async$Transferables__getObjects($async$errorCode, $async$result) {
    ...
    Transferables__get($async$message, $async$seen) {
      return A._makeSyncStarIterable(function() {
        var message = $async$message,
          seen = $async$seen;
        var $async$goto = 0, $async$handler = 2, $async$currentError, t1, toBeInspected, t2, i, i0, arg, t3;
        return function $async$Transferables__get($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
            ...
            switch ($async$goto) {
              ...
              case 6:
                ...
                if (!J.every$1$ax(t3.get$keys(arg), A._transferables_Transferables__isBaseType$closure()))
                  A.throwExpression(A.newSquadronError("Map keys must be strings, numbers or booleans.", A.StackTrace_current()));
    ...
    WorkerRequestExt_unwrapRequest(_this) {
      ...
      if (t2 == null)
        ...
        t3 = new A._JsWorkerChannel();
        t3._sendPort = type$.nullable_MessagePort._as(t2);
        t2 = t3;
      }
      t1.$indexSet(_this, 1, t2);
      ...
      ts = t1.$index(_this, 0);
      if (ts != null)
        t1.$indexSet(_this, 0, A.Duration$(new A.DateTime(Date.now(), false).toUtc$0()._value - type$.DateTime._as($.$get$_sqEpoch())._value)._duration - A._asInt(ts));
    },
    safeInvoke(callback) {
      var e, exception, t1;
      try {
    ...
    main() {
      A.bootstrap(A.perf__$PerfInitializer$closure(), null, null);
    }
  },
  J = {
  ...
  A.bootstrap_closure0.prototype = {
    call$1($event) {
      return this.runner.processMessage$1(type$.List_dynamic._as(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as($event).data, true)));
    },
    $signature: 12
  };
  A.bootstrap_closure1.prototype = {
    call$1($event) {
      var t1 = type$.nullable_List_dynamic._as(new A._AcceptStructuredCloneDart2Js([], []).convertNativeToDart_AcceptStructuredClone$2$mustCopy(type$.MessageEvent._as($event).data, true)),
        t2 = this.com.port2;
      t2.toString;
      return this.runner.connect$3(t1, t2, this.initializer);
    },
    $signature: 12
  };
  A._BaseJsChannel.prototype = {
    _postResponse$2(res, inspectResponse) {
      var transfer, ex, st, res0, t1, exception;
      if (1 >= res.length)
        return A.ioore(res, 1);
      res0 = res[1];
      if (!type$.List_dynamic._is(res0) && type$.Iterable_dynamic._is(res0))
        B.JSArray_methods.$indexSet(res, 1, J.toList$0$ax(res0));
      if (2 >= res.length)
        return A.ioore(res, 2);
      t1 = type$.nullable_SquadronException._as(res[2]);
      B.JSArray_methods.$indexSet(res, 2, t1 == null ? null : t1.serialize$0());
      t1 = $.Squadron__instance;
      if (t1 == null ? $.Squadron___debugMode : t1._debugMode)
        B.JSArray_methods.$indexSet(res, 0, A.Duration$(new A.DateTime(Date.now(), false).toUtc$0()._value - type$.DateTime._as($.$get$_sqEpoch())._value)._duration);
      try {
        if (inspectResponse) {
          ...
          t1 = this._sendPort;
          t1.toString;
          B.MessagePort_methods.postMessage$2(t1, res, transfer);
        } else {
          t1 = this._sendPort;
          t1.toString;
          B.MessagePort_methods.postMessage$1(t1, res);
        }
      } catch (exception) {
  ...
  A._JsWorkerChannel.prototype = {
    error$1(_, error) {
      ...
      this._postResponse$2([null, null, A.SquadronException_from(error, null), null, null], false);
    },
    $isWorkerChannel: 1
  };
  ...
  A.WorkerRunner.prototype = {
    ...
    connect$body$WorkerRunner(startRequest, channelInfo, initializer) {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$currentError, $async$self = this, client, service, $init, operations, ex, st, t2, t3, sq, value, exception, t1, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              client = t1 ? null : type$.nullable_WorkerChannel._as(J.$index$asx(startRequest, 1));
              if (t1)
                throw A.wrapException(A.newSquadronError("connection request expected", A.StackTrace_current()));
              else if (client == null)
                throw A.wrapException(A.newSquadronError("missing client for connection request", A.StackTrace_current()));
              $async$handler = 3;
              t1 = J.getInterceptor$asx(startRequest);
              if (A._asInt(t1.$index(startRequest, 2)) !== -1) {
                t1 = A.newSquadronError("connection request expected", A.StackTrace_current());
                throw A.wrapException(t1);
              } else {
                t2 = $async$self._operations;
                if (t2._length !== 0) {
                  t1 = A.newSquadronError("already connected", A.StackTrace_current());
                  throw A.wrapException(t1);
                }
              }
            ...
            case 7:
              ...
              if (!t3.get$isEmpty(t3)) {
                t1 = A.newSquadronError("invalid command identifier in service operations map; command ids must be > 0", A.StackTrace_current());
                throw A.wrapException(t1);
              }
              t2.addAll$1(0, operations);
              client._postResponse$2([null, channelInfo, null, null, null], true);
              $async$handler = 1;
              // goto after finally
              $async$goto = 5;
              break;
    ...
    processMessage$body$WorkerRunner(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, client, tokenRef, op, result, inspectResponse, subscription, done, shutdown, streamId, e, st, t1, t2, t3, token, t4, t5, t6, action, exception, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              client = type$.nullable_WorkerChannel._as(t1.$index(request, 1));
              if (A._asInt(t1.$index(request, 2)) === -4) {
                ...
                throw A.wrapException(A.newSquadronError("missing client for request: " + A.S(request), A.StackTrace_current()));
              t2 = $async$self._monitor;
              ++t2._executing;
              t3 = type$.nullable_CancellationToken;
              token = t2._getTokenRef$1(t3._as(t1.$index(request, 4)));
              if (token._hasRef) {
                ++token._refCount;
                if (t3._as(t1.$index(request, 4)) == null || t3._as(t1.$index(request, 4))._cancellation_token$_id !== token._cancellation_token$_id)
                  A.throwExpression(A.newSquadronError("cancellation token mismatch", A.StackTrace_current()));
                t1.$indexSet(request, 4, token);
              } else if (t3._as(t1.$index(request, 4)) != null)
                A.throwExpression(A.newSquadronError("Token reference mismatch", A.StackTrace_current()));
              tokenRef = token;
              $async$handler = 4;
              if (A._asInt(t1.$index(request, 2)) === -1) {
                t1 = A.newSquadronError("unexpected connection request: " + A.S(request), A.StackTrace_current());
                throw A.wrapException(t1);
              } else {
            ...
            case 8:
              // join
              inspectResponse = A._asBool(t1.$index(request, 7));
            ...
            case 10:
              ...
              t4 = t3._as(shutdown);
              t5 = ++t2._streamId;
              t6 = t2._streamCancellers;
              if (t6 == null) {
                t3 = A.LinkedHashMap_LinkedHashMap$_empty(type$.int, t3);
                t2.set$_streamCancellers(t3);
              } else
                t3 = t6;
              t3.$indexSet(0, t5, t4);
              if (t1._hasRef)
                t1.super$CancellationToken$addListener(0, t4);
              streamId = t5;
              client._postResponse$2([null, A._asInt(streamId), null, null, null], false);
              t1 = subscription;
              ...
              if (t4 == null ? t1 != null : t4 !== t1)
                A.throwExpression(new A.LateError("Local '" + t1._name + "' has already been initialized."));
              t1.__late_helper$_value = t3;
              t1 = done.future;
              action = type$.dynamic_Function._as(new A.WorkerRunner_processMessage_closure1($async$self, tokenRef, streamId));
              t3 = t1.$ti;
              result = new A._Future($.Zone__current, t3);
              t1._addListener$1(new A._FutureListener(result, 8, action, null, t3._eval$1("@<1>")._bind$1(t3._precomputed1)._eval$1("_FutureListener<1,2>")));
              $async$goto = 13;
              return A._asyncAwait(result, $async$processMessage$1);
            case 13:
              // returning from await.
            ...
            case 12:
              // else
              client._postResponse$2([null, result, null, null, null], A._asBool(inspectResponse));
            case 11:
              // join
              $async$next.push(6);
              // goto finally
            ...
            case 5:
              ...
              if (t1._refCount === 0 && t1._cancellation_token$_exception == null)
                t2._cancelTokens.remove$1(0, t1._cancellation_token$_id);
              t1 = --t2._executing;
              if (t2._terminationRequested && t1 === 0)
                t2._terminate.call$0();
  ...
  A.WorkerRunner_processMessage_shutdown.prototype = {
    call$0() {
      var t1, t2;
      this.client._postResponse$2([null, null, null, true, null], false);
  ...
  A.WorkerRunner_processMessage_closure.prototype = {
    call$1(data) {
      return this.client._postResponse$2([null, data, null, null, null], this.inspectResponse);
    },
    $signature: 4
  };
  A.WorkerRunner_processMessage_closure0.prototype = {
    call$2(ex, st) {
      return this.client.error$1(0, A.SquadronException_from(ex, type$.nullable_StackTrace._as(st)));
    },
    $signature: 13
  };
  ...
  A.GenericData.prototype = {
    toJson$0() {
      var exception,
        t1 = type$.dynamic,
        json = A.LinkedHashMap_LinkedHashMap$_empty(t1, t1);
      J.$indexSet$ax(json, "n", this.name);
      t1 = this.value;
      if (t1 != null)
        try {
          J.$indexSet$ax(json, "v", t1.toJson$0());
        } catch (exception) {
          J.$indexSet$ax(json, "v", t1);
        }
      return json;
    }
  };
  A.StringPersonMarshaller.prototype = {
    marshall$1(data) {
      type$.Person._as(data);
      return data.lastName + "\x00" + data.firstName + "\x00" + data.dob.toString$0(0);
    }
  };
  A.$PerfOperations.prototype = {
    get$operations() {
      var _this = this,
        ops = _this.$$PerfOperations__operations;
      if (ops == null) {
        ops = A.LinkedHashMap_LinkedHashMap$_literal([1, new A.$PerfOperations_operations_closure(_this), 2, new A.$PerfOperations_operations_closure0(_this), 3, new A.$PerfOperations_operations_closure1(_this), 4, new A.$PerfOperations_operations_closure2(_this), 5, new A.$PerfOperations_operations_closure3(_this), 6, new A.$PerfOperations_operations_closure4(_this), 7, new A.$PerfOperations_operations_closure5(_this), 8, new A.$PerfOperations_operations_closure6(_this), 9, new A.$PerfOperations_operations_closure7(_this)], type$.int, type$.dynamic_Function_List_dynamic);
        _this.set$_perf$_operations(ops);
      }
      return ops;
    },
    set$_perf$_operations(_operations) {
      this.$$PerfOperations__operations = type$.nullable_Map_of_int_and_dynamic_Function_List_dynamic._as(_operations);
    }
  };
  A.$PerfOperations_operations_closure.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure5(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure5(req) {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = type$.BigInt;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.add$2(0, A._BigIntImpl_parse(A._asString(J.$index$asx(t2._as(t1.$index(req, 3)), 0)), null), A._BigIntImpl_parse(A._asString(J.$index$asx(t2._as(t1.$index(req, 3)), 1)), null)), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._as($async$result).toString$0(0);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.$PerfOperations_operations_closure0.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure4(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure4(req) {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.negateWithByteBufferInput$1(A.NativeUint32List_NativeUint32List$view(type$.ByteBuffer._as(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0)), 0, null)), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.cast$1$0$ax($async$result, type$.int);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.$PerfOperations_operations_closure1.prototype = {
    call$1(req) {
      var t1 = type$.List_dynamic;
      return this.$this.negateWithByteBufferOutput$1(type$.List_int._as(J.cast$1$0$ax(J.$index$asx(t1._as(J.$index$asx(t1._as(req), 3)), 0), type$.int)));
    },
    $signature: 32
  };
  A.$PerfOperations_operations_closure2.prototype = {
    call$1(req) {
      var t1 = type$.List_dynamic;
      return this.$this.negateWithJsonOutput$1(type$.List_int._as(J.cast$1$0$ax(J.$index$asx(t1._as(J.$index$asx(t1._as(req), 3)), 0), type$.int)));
    },
    $signature: 5
  };
  A.$PerfOperations_operations_closure3.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure3(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure3(req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, $async$self = this, $async$temp1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.negateWithListInput$1(A.NativeUint32List_NativeUint32List$view(type$.ByteBuffer._as(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0)), 0, null)), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.cast$1$0$ax($async$result, type$.int);
              // goto return
  ...
  A.$PerfOperations_operations_closure4.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure2(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure2(req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.negateWithListOutput$1(type$.List_int._as(J.cast$1$0$ax(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0), t1))), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.cast$1$0$ax($async$result, t1);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.$PerfOperations_operations_closure5.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure1(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure1(req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, $async$self = this, t1, $async$temp1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = J;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.negateWithStringInput$1(A.List_List$of(new A.MappedListIterable(A._setArrayType(A._asString(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0)).split(";"), type$.JSArray_String), type$.int_Function_String._as(A.core_int_parse$closure()), t1), true, t1._eval$1("ListIterable.E"))), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.cast$1$0$ax($async$result, type$.int);
              // goto return
  ...
  A.$PerfOperations_operations_closure6.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure0(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure0(req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$self = this, $async$temp1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$temp1 = B.C_StringPersonMarshaller;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.sendGenericData$1(A.GenericData_GenericData$fromJson(type$.Map_dynamic_dynamic._as(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0)), type$.Person)), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.marshall$1($async$result);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.$PerfOperations_operations_closure7.prototype = {
    call$1(req) {
      return this.$call$body$$PerfOperations_operations_closure(type$.List_dynamic._as(req));
    },
    $call$body$$PerfOperations_operations_closure(req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$self = this, $async$temp1;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = B.C_StringPersonMarshaller;
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.sendGenericDataAsJson$1(A._asString(J.$index$asx(type$.List_dynamic._as(J.$index$asx(req, 3)), 0))), $async$call$1);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.marshall$1($async$result);
              // goto return
  ...
  A.Person.prototype = {
    toJson$0() {
      return [this.lastName, this.firstName, this.dob.toIso8601String$0()];
    }
  };
  A.PerfContext.prototype = {
    toJson$0() {
      return B.Map_empty;
    }
  };
  A.Perf.prototype = {
    add$2(_, a, b) {
      var $async$goto = 0,
        ...
        $async$returnValue;
      var $async$add$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
      ...
      return A._asyncStartSync($async$add$2, $async$completer);
    },
    sendGenericData$1(personData) {
      return this.sendGenericData$body$Perf(type$.GenericData_Person._as(personData));
    },
    sendGenericData$body$Perf(personData) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Person),
        $async$returnValue, t1;
      var $async$sendGenericData$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
      ...
      return A._asyncStartSync($async$sendGenericData$1, $async$completer);
    },
    sendGenericDataAsJson$1(json) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.Person),
        $async$returnValue, t1;
      var $async$sendGenericDataAsJson$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.GenericData_GenericData$fromJson(type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(0, json, null)), type$.Person).value;
              t1.toString;
              $async$returnValue = t1;
              // goto return
              $async$goto = 1;
      ...
      return A._asyncStartSync($async$sendGenericDataAsJson$1, $async$completer);
    },
    negateWithListInput$1(data) {
      return this.negateWithListInput$body$Perf(type$.List_int._as(data));
    },
    negateWithListInput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, t1, t2;
      var $async$negateWithListInput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.instanceType(data);
              t2 = t1._eval$1("MappedListIterable<ListBase.E,int>");
              $async$returnValue = A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(ListBase.E)")._as(new A.Perf_negateWithListInput_closure()), t2), true, t2._eval$1("ListIterable.E"));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithListInput$1, $async$completer);
    },
    negateWithByteBufferInput$1(data) {
      return this.negateWithByteBufferInput$body$Perf(type$.List_int._as(data));
    },
    negateWithByteBufferInput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, t1, t2;
      var $async$negateWithByteBufferInput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = A.instanceType(data);
              t2 = t1._eval$1("MappedListIterable<ListBase.E,int>");
              $async$returnValue = A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(ListBase.E)")._as(new A.Perf_negateWithByteBufferInput_closure()), t2), true, t2._eval$1("ListIterable.E"));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithByteBufferInput$1, $async$completer);
    },
    negateWithStringInput$1(data) {
      return this.negateWithStringInput$body$Perf(type$.List_int._as(data));
    },
    negateWithStringInput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, t1, t2;
      var $async$negateWithStringInput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$returnValue = A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(1)")._as(new A.Perf_negateWithStringInput_closure()), t2), true, t2._eval$1("ListIterable.E"));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithStringInput$1, $async$completer);
    },
    negateWithListOutput$1(data) {
      return this.negateWithListOutput$body$Perf(type$.List_int._as(data));
    },
    negateWithListOutput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_int),
        $async$returnValue, t1, t2;
      var $async$negateWithListOutput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = data.$ti;
              t2 = t1._eval$1("MappedListIterable<ListBase.E,int>");
              $async$returnValue = A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(ListBase.E)")._as(new A.Perf_negateWithListOutput_closure()), t2), true, t2._eval$1("ListIterable.E"));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithListOutput$1, $async$completer);
    },
    negateWithByteBufferOutput$1(data) {
      return this.negateWithByteBufferOutput$body$Perf(type$.List_int._as(data));
    },
    negateWithByteBufferOutput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.ByteBuffer),
        $async$returnValue, t1, t2;
      var $async$negateWithByteBufferOutput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = data.$ti;
              t2 = t1._eval$1("MappedListIterable<ListBase.E,int>");
              $async$returnValue = new Int32Array(A._ensureNativeList(A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(ListBase.E)")._as(new A.Perf_negateWithByteBufferOutput_closure()), t2), true, t2._eval$1("ListIterable.E")))).buffer;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithByteBufferOutput$1, $async$completer);
    },
    negateWithJsonOutput$1(data) {
      return this.negateWithJsonOutput$body$Perf(type$.List_int._as(data));
    },
    negateWithJsonOutput$body$Perf(data) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t1, t2;
      var $async$negateWithJsonOutput$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = data.$ti;
              t2 = t1._eval$1("MappedListIterable<ListBase.E,int>");
              $async$returnValue = B.C_JsonCodec.encode$2$toEncodable(A.List_List$of(new A.MappedListIterable(data, t1._eval$1("int(ListBase.E)")._as(new A.Perf_negateWithJsonOutput_closure()), t2), true, t2._eval$1("ListIterable.E")), null);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$negateWithJsonOutput$1, $async$completer);
    }
  };
  A.Perf_negateWithListInput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A.Perf_negateWithByteBufferInput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A.Perf_negateWithStringInput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A.Perf_negateWithListOutput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A.Perf_negateWithByteBufferOutput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A.Perf_negateWithJsonOutput_closure.prototype = {
    call$1(n) {
      return -A._asInt(n);
    },
    $signature: 2
  };
  A._Perf_WorkerService_$PerfOperations.prototype = {};
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(A.CastStreamSubscription.prototype, "get$__internal$_onData", "__internal$_onData$1", 24);
    ...
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 21, 0, 0);
    ...
    _static_1(A, "perf__$PerfInitializer$closure", "$PerfInitializer", 35);
    _static_1(A, "perf_Person___fromJson_tearOff$closure", "Person___fromJson_tearOff", 36);
    _static_1(A, "_transferables_Transferables__isBaseType$closure", "Transferables__isBaseType", 8);
    _static_1(A, "_transferables_Transferables__isSafeForTransfer$closure", "Transferables__isSafeForTransfer", 8);
    _static_1(A, "_transferables_Transferables__isNotSafeForTransfer$closure", "Transferables__isNotSafeForTransfer", 8);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Stream, A.CastStreamSubscription, A.Iterable, A.CastIterator, A.Error, A.Closure, A.SentinelValue, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.ConstantMap, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._IterationMarker, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A._MapBaseValueIterator, A.Codec, A.Converter, A._JsonStringifier, A._BigIntImpl, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.Null, A._StringStackTrace, A.StringBuffer, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A._StructuredClone, A._AcceptStructuredClone, A.NullRejectionException, A._BaseJsChannel, A.CancellationToken, A.Squadron, A.SquadronError, A.SquadronException, A.WorkerService, A.TokenId, A.WorkerMonitor, A.WorkerRunner, A.GenericData, A.StringPersonMarshaller, A.$PerfOperations, A.Person, A.PerfContext]);
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A._ConstantMapKeyIterable, A._SyncStarIterable]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.ConstantStringMap_values_closure, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._JsonMap_values_closure, A._BigIntImpl_hashCode_finish, A.DateTime_parse_parseIntOrZero, A.DateTime_parse_parseMilliAndMicroseconds, A._EventStreamSubscription_closure, A._EventStreamSubscription_onData_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.bootstrap_closure0, A.bootstrap_closure1, A.WorkerRunner_connect_closure, A.WorkerRunner_processMessage_closure, A.$PerfOperations_operations_closure, A.$PerfOperations_operations_closure0, A.$PerfOperations_operations_closure1, A.$PerfOperations_operations_closure2, A.$PerfOperations_operations_closure3, A.$PerfOperations_operations_closure4, A.$PerfOperations_operations_closure5, A.$PerfOperations_operations_closure6, A.$PerfOperations_operations_closure7, A.Perf_negateWithListInput_closure, A.Perf_negateWithByteBufferInput_closure, A.Perf_negateWithStringInput_closure, A.Perf_negateWithListOutput_closure, A.Perf_negateWithByteBufferOutput_closure, A.Perf_negateWithJsonOutput_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__chainFuture_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.bootstrap_closure, A._JsWorkerChannel_error_closure, A.WorkerMonitor__getTokenRef_closure, A.WorkerRunner_processMessage_shutdown, A.WorkerRunner_processMessage_closure1]);
    ...
    _inherit(A._Perf_WorkerService_$PerfOperations, A.WorkerService);
    _inherit(A.Perf, A._Perf_WorkerService_$PerfOperations);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      GenericData_Person: findType("GenericData<Person>"),
...
;
    ...
    B.C_StringPersonMarshaller = new A.StringPersonMarshaller();
  ...
  (function staticFields() {
    ...
    $.GenericData__deserializers = A.LinkedHashMap_LinkedHashMap$_empty(A.findType("Type"), A.findType("@(@)"));
  })();
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_sqEpoch", "$get$_sqEpoch", () => new A.DateTime(A.checkInt(A.Primitives_valueFromDecomposedDate(2020, 1, 1, 0, 0, 0, A.DateTime__microsecondInRoundedMilliseconds(0), true)), true));
    _lazyFinal($, "TokenId__instance", "$get$TokenId__instance", () => new A.TokenId());
    _lazyFinal($, "PerfContext_singleton", "$get$PerfContext_singleton", () => {
      $.GenericData__deserializers.$indexSet(0, A.createRuntimeType(type$.Person), A.perf_Person___fromJson_tearOff$closure());
      return new A.PerfContext();
    });
  })();
